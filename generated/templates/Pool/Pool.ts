...
export class Pool__getStatesResult {
  value0: BigInt;
  value1: BigInt;
...
export class Pool extends ethereum.SmartContract {
  ...
  getStates(): Pool__getStatesResult {
    let result = super.call("getStates", "getStates():(uint256,uint256)", []);

    return new Pool__getStatesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }

  try_getStates(): ethereum.CallResult<Pool__getStatesResult> {
    let result = super.tryCall(
      "getStates",
      "getStates():(uint256,uint256)",
      [],
    );
    if (result.reverted) {
      return new ethereum.CallResult();
    ...
    return ethereum.CallResult.fromValue(
      new Pool__getStatesResult(value[0].toBigInt(), value[1].toBigInt()),
    );
  }
...
export class LinkedTransferCall extends ethereum.Call {
  get inputs(): LinkedTransferCall__Inputs {
    return new LinkedTransferCall__Inputs(this);
  }

  get outputs(): LinkedTransferCall__Outputs {
    return new LinkedTransferCall__Outputs(this);
  }
}

export class LinkedTransferCall__Inputs {
  _call: LinkedTransferCall;

  constructor(call: LinkedTransferCall) {
    this._call = call;
  }
...
export class LinkedTransferCall__Outputs {
  _call: LinkedTransferCall;
